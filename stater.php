            ...
            <!-- general form elements -->
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Form Jadwal Stater</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="controller/cstater.php">
                  <div class="box-body">
                    <!-- select -->
...
join tb_jenis_kandang sr on sr.id_jenis_kandang=kd.id_jenis_kandang  where  sr.id_jenis_kandang='S' and id_peternakan = '".$_SESSION['username']."'");
...
?><tr>
    ...
    <td>[<a href="admin.php?page=editsiswa&id=<?php echo $rdata["nis"];?>">Stop</a> ] /
     [ <a href="admin.php?page=hapussiswa&id=<?php echo $rdata["nis"];?>">Edit</a> ] </td>
