         ...
         <div class="box">
            ...
            <!-- general form elements -->
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="index.php?inputgrower">
                  <div class="box-body">
                    <!-- select -->
...
join tb_jenis_kandang sr on sr.id_jenis_kandang=kd.id_jenis_kandang  where  sr.id_jenis_kandang='G' and id_peternakan = '".$_SESSION['idpt']."'");
...
<td><?php echo $var["id_kandang"];?>&nbsp;</td>
    ...
    <td><a class="btn btn-warning" href="index.php?rsgrw&idjd=<?php echo $var["id_jadwal"];?>&jns=<?php echo $var["id_jenis_jadwal"];?>">Restart</a> -  <a class="btn btn-danger" href="index.php?delgrw&idjd=<?php echo $var["id_jadwal"];?>">Delete</a>  </td>
...
$indeks=$indeks+1;
 ...
 } else { ?> <tr> <td colspan="5"> <h3>Maaf data jadwal Grower masih kosong</h3></td> </tr>
 <?php  }?> 
                    </tbody>
                  </table>
                </div><!-- /.box-body -->
