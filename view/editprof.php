      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="callout callout-info">
            <h4>Ubah Profil</h4>
            <p>Mengubah data pribadi Anda </p>
          </div>
...
foreach ( $data as $var ) {
                ...
                <!-- form start -->
                <form role="form" method="post" action="index.php?updatepakr">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">User Name Karyawan</label>
                      <input type="disabled" class="form-control" value="<?php echo $_SESSION["idkar"];?>" placeholder="username" name="usr" disabled>
                    </div>
                    <div class="form-group">
