      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="callout callout-info">
            <h4>Jadwal Indukan</h4>
            <p>Menampilkan jadwal dari kandang indukan</p>
          </div>
            ...
            <!-- general form elements -->
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Form Jadwal Indukan</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="index.php?inputindk">
                  <div class="box-body">
                    <!-- select -->
...
join tb_jenis_kandang sr on sr.id_jenis_kandang=kd.id_jenis_kandang  where  sr.id_jenis_kandang='I' and id_peternakan = '".$_SESSION['idpt']."'");
...
//SELECT * FROM tb_matakuliah tbmk 
  //    join tb_pengajuanmatakuliahreguler tbpmkr on tbmk.id_matkul=tbpmkr.id_matkul where id_tahunakademik ='.$id
$data=mysql_query("select * from tb_jenis_jadwal where id_jenis_jadwal<>'shu' ");
//menampilkan data hasil query menjadi data array
while($rdata=mysql_fetch_array($data)){
?>
...
<td><?php echo $var["id_kandang"];?>&nbsp;</td>
    ...
    <td><a class="btn btn-warning" href="index.php?rsindk&idjd=<?php echo $var["id_jadwal"];?>&jns=<?php echo $var["id_jenis_jadwal"];?>">Restart</a> -  <a class="btn btn-danger" href="index.php?delindk&idjd=<?php echo $var["id_jadwal"];?>">Delete</a>  </td>
...
$indeks=$indeks+1;
 ...
 } else { ?> <tr> <td colspan="5"> <h3>Maaf data jadwal Indukan masih kosong</h3></td> </tr>
 <?php  }?> 
                    </tbody>
                  </table>
                </div><!-- /.box-body -->
