         ...
         <div class="box">
            ...
            <!-- general form elements -->
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="index.php?inputkandang">
                  <div class="box-body">
...
?><tr>
  ...
  <td>
                                        [ <a href="index.php?editkand&idkd=<?php echo $var['id_kandang'];?>">Edit</a> ] </td>
                                </tr>
 <?php } 
 } else { ?> <h3>Maaf data kandang masih kosong</h3>
 <?php  }?>
                    </tbody>
                  </table>
                </div><!-- /.box-body -->
