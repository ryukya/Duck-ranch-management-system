         ...
         <div class="box">
            ...
            <!-- general form elements -->
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="index.php?updatekandang">
                <?php 
...
?>
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="disabled" class="form-control" value="<?php echo $var['id_kandang'];?>" placeholder="idkandang" name="idk" disabled>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Isi Kandang</label>
                      <input type="text" class="form-control" value="<?php echo $var['isi_kandang'];?>"   placeholder="isi" name="isi">
                    </div>
                             <div class="form-group">
...
$data2=mysql_query("select * from tb_jenis_kandang");
//menampilkan data hasil query menjadi data array
while($rdata=mysql_fetch_array($data2)){
?>
    <option value="<?php echo $rdata["id_jenis_kandang"];?>"  <?php if($var['id_jenis_kandang']==$rdata["id_jenis_kandang"])
    {?> selected <?php }?> > <?php echo $rdata["nama_jenis_kandang"];?>&nbsp;</option>
 ...
 <?php } ?> 
                  ...
                  <div class="box-footer">
                    ...
                    <a href="index.php?kandang" class="btn btn-danger" name="create">Batal</a>
                  </div>
                </form>
              </div><!-- /.box -->
