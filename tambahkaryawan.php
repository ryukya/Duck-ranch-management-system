      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="callout callout-info">
            ...
            <p>Menambah data tentang karyawan anda</p>
          </div>
         ...
         <div class="box">
            ...
            <!-- general form elements -->
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="controller/ctambah.php">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">User Name Karyawan</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="username" name="usr">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama Karyawan</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="nama" name="nm">
                    </div>
                             <div class="form-group">
...
join tb_jenis_kandang sr on sr.id_jenis_kandang=kd.id_jenis_kandang  where   id_peternakan = '".$_SESSION['username']."'");
...
?>
 ...
 <?php } ?> 
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Password" name="passkar">
                    </div>
                    <div class="form-group">
