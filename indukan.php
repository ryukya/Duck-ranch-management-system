          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="../tables/data.html"><i class="fa fa-circle-o"></i> Jadwal Indukan</a></li>
              </ul>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="callout callout-info">
            ...
            <p>Menampilkan jadwal dari kandang Indukan. 
            Kandang Indukan adalah kandang untuk bebek indukan</p>
          </div>
         ...
         <div class="box">
            ...
            <!-- general form elements -->
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="controller/cindukan.php">
                  <div class="box-body">
                    <!-- select -->
...
join tb_jenis_kandang sr on sr.id_jenis_kandang=kd.id_jenis_kandang  where  sr.id_jenis_kandang='I' and id_peternakan = '".$_SESSION['username']."'");
...
?><tr>
    ...
    <td>[<a href="admin.php?page=editsiswa&id=<?php echo $rdata["nis"];?>">Stop</a> ] / [ <a href="admin.php?page=hapussiswa&id=<?php echo $rdata["nis"];?>">Edit</a> ] </td>
