...
?>
  ...
  <tr>
   <td> Id Peternakan</td> <td><?php echo $rdata["id_peternakan"];?>&nbsp;</td></tr>
  <tr>
   <td>password</td> <td><?php echo $rdata["password"];?>&nbsp;</td>
   </tr>
   <tr>
   <td>nama pemilik</td> <td><?php echo $rdata["nama_pemilik"];?>&nbsp;</td>
    </tr>
    <tr>
    <td>nama peternakan</td><td><?php echo $rdata["nama_peternakan"];?>&nbsp;</td>
    </tr>
    <tr>
    <td>tanggal berdiri</td><td><?php echo $rdata["tanggal_berdiri"];?>&nbsp;</td>
    </tr>
    <tr>
    <td>jumlah kandang starter</td><td><?php echo $rdata["jumlah_kandang_stater"];?>&nbsp;</td>
    </tr>
    <tr>
    <td>luas kandang starter</td><td><?php echo $rdata["luas_kandang_stater"];?>&nbsp;</td>
    </tr>
    <tr>
    <td>jumlah kandang grower</td><td><?php echo $rdata["jumlah_kandang_grower"];?>&nbsp;</td>
    </tr>
    <tr>
    <td>luas kandang grower</td><td><?php echo $rdata["luas_kandang_grower"];?>&nbsp;</td>
    </tr>
    <tr>
    <td>jumlah kandang indukan</td><td><?php echo $rdata["jumlah_kandang_indukan"];?>&nbsp;</td>
    </tr>
    <tr>
    <td>luas kandang indukan</td><td><?php echo $rdata["luas_kandang_indukan"];?>&nbsp;</td>
    </tr>
   <tr>
    <td><a href="admin.php?page=editsiswa&id=<?php echo $rdata["nis"];?>">Edit</a>  </td>
  </tr>
 <?php } ?> 
                    </table>
...
//SELECT * FROM tb_matakuliah tbmk 
  //    join tb_pengajuanmatakuliahreguler tbpmkr on tbmk.id_matkul=tbpmkr.id_matkul where id_tahunakademik ='.$id
$data=mysql_query("select * from tb_karyawan kr join tb_pembagian pg on pg.id_karyawan=kr.id_karyawan 
join  tb_kandang kd on kd.id_kandang=pg.id_kandang 
join tb_peternakan pk on pk.id_peternakan=kd.id_peternakan where pk.id_peternakan = '".$_SESSION['username']."'");
//menampilkan data hasil query menjadi data array
while($rdata=mysql_fetch_array($data)){
?><tr>
    <td><?php echo $rdata["id_pembagian"];?>&nbsp;</td>
    <td><?php echo $rdata["id_karyawan"];?>&nbsp;</td>
    <td><?php echo $rdata["nama_karyawan"];?>&nbsp;</td>
    <td><?php echo $rdata["pass"];?>&nbsp;</td>
